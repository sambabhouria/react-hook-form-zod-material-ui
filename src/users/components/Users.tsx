    ...
    <Container maxWidth="sm" component="form" onSubmit={handleSubmit(onSubmit)}>
      <Stack sx={{ flexDirection: 'row', gap: 2 }}>
        ...
        <Stack sx={{ gap: 2 }}>
          ...
          {/* <Button onClick={() => append({ name: '' })} type="button">  type="button" if not will submit the form*/}
          {isTeacher && (
          ...
          {fields.map((field, index) => (
            <Fragment key={field.id}>
              ...
              <Button
                ...
                type="button" // pass the type button to avoid submit the form
              >
                Remove
              </Button>
            </Fragment>
          ...
          <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            {/* <button onClick={()=> schema.parse(getValues())>test</button> help for deburging*/}
